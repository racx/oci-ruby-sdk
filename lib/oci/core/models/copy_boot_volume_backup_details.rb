...
module OCI
  ...
  class Core::Models::CopyBootVolumeBackupDetails
    ...
    # If you do not specify this attribute the boot volume backup will be encrypted with the Oracle-provided encryption
